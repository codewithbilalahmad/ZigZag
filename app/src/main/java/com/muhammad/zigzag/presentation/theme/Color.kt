...
val surfaceDimLight = Color(0xFFDEDCDC)
val surfaceBrightLight = Color(0xFFFBF9F9)

val surfaceContainerLowestLight = Color(0xFFFFFFFF)
val surfaceContainerLowLight = Color(0xFFF7F2F2)
val surfaceContainerLight = Color(0xFFF3EFEF)
val surfaceContainerHighLight = Color(0xFFEDE8E8)
val surfaceContainerHighestLight = Color(0xFFE7E2E2)
